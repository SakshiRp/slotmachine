...
import "./Home.css"
import coin from '../assets/KC Coin.svg'
...
// resets spinner to initial state and calls for acknowledgement API
 ...
 return (
    <div className="container">
     ...
     <h5 className="head">3 rows p same items me inaam milega!</h5>
     {/* modal for the case when user lands in the webview when the ack of previous game has not been received */}
     {
    ...
    {/* dummy spinner when the API response has not been received */}
      {
